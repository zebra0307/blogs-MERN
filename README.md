# Z Blogs
A full-stack modern blog platform for a tech community, offering anonymous discussion, regular tech articles, and a repository for university question papers.

## Features
- **Modern UI:** Built with React, Tailwind CSS, and Flowbite React for a responsive, clean aesthetic.
- **Backend:** Node.js, Express, and MongoDB powering robust REST APIs.
- **Authentication:** JWT-based secure authentication with Google OAuth/Firebase integration.
